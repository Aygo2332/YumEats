  ...
  return (
    <div className='mx-auto flex justify-between items-center p-4'>
        <div className='flex items-center'>
          ...
          <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2'>Bite<span className='font-bold'>Joy</span></h1>
        ...
        <div className={sideNav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300' : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300'}>
          ...
          <h2 className='text-2xl p-4'>Bite<span className='text-orange-700 font-bold'>Joy</span></h2>
          <nav>
